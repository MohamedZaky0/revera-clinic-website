...
-- DRY RUN: use scripts/backfill_historical_invoices_dry_run.sql (SELECT only). Do NOT edit this file's final
-- SELECT to make a dry run: Postgres executes data-modifying CTEs even when the final SELECT ignores them.
