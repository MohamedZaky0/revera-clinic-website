...
const women: LandingCopy = {
  ...
  metaDescription:
    "ليزر إزالة الشعر في التجمع الخامس. تقييم لبشرتك ونوع شعرك، إعدادات على مقاسك، وخطة واضحة من أول زيارة — من غير ضغط للحجز.",
  eyebrow: "عيادة ليزر في التجمع الخامس",
  h1: "ليزر إزالة الشعر في التجمع الخامس — بإعدادات تتظبط على بشرتك",
  ...
  problems: [
    ...
    { q: "جهاز مجهول", a: "نسألك وتعرفي اسم الجهاز والمناسب لحالتك بوضوح قبل الحجز." },
  ...
  faq: [
    {
      ...
      a: "أيوه، ممكن يكون مناسب حسب نوع بشرتك والجهاز والإعدادات. بنحدد ده في التقييم قبل الجلسة الأولى.",
    },
    pain,
    ...
    { ...guarantee, q: "هل النتيجة مضمونة من أول جلسة؟" },
    {
      ...
      a: "طبعًا. بنقولك اسم الجهاز ونوع الليزر المستخدم وليه مناسب لحالتك قبل ما تحجزي، وتقدري تسألي عنه في أول رسالة.",
    },
    {
...
const womenDark: LandingCopy = {
  ...
  metaDescription:
    "ليزر إزالة الشعر للبشرة السمراء والقمحية في التجمع الخامس. اختبار بقعة وإعدادات محسوبة حسب بشرتك قبل أي جلسة كاملة.",
  h1: "ليزر للبشرة السمراء في التجمع الخامس — بعد اختبار بقعة وإعدادات محسوبة",
...
const men: LandingCopy = {
  ...
  metaDescription:
    "ليزر إزالة الشعر للرجال في التجمع الخامس. تقييم واضح، إعدادات محسوبة، وخطة مفهومة من أول زيارة — من غير مبالغة ولا وعود سهلة.",
  eyebrow: "ليزر رجالي في التجمع الخامس",
  h1: "ليزر إزالة الشعر للرجال في التجمع الخامس — خطة واضحة بدل الحلاقة كل يوم",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "ممكن يكون مناسب حسب نوع بشرتك والجهاز والإعدادات. بنحدد ده في التقييم قبل الجلسة الأولى.",
    },
    guarantee,
    where,
  ],
