...
export function WhatsappButton() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 z-[999] flex items-center justify-center rounded-full bg-[#25D366] p-4 text-white shadow-[0_4px_20px_rgba(37,211,102,0.4)] transition-all duration-300 hover:scale-110 hover:bg-[#20ba5a] hover:shadow-[0_8px_30px_rgba(37,211,102,0.6)] focus:outline-none active:scale-95 group ${
