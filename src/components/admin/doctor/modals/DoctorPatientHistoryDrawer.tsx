...
export default function DoctorPatientHistoryDrawer({
  ...
  return (
    <div className="fixed top-0 bottom-0 [inset-inline-start:0] md:[inset-inline-start:280px] [inset-inline-end:0] z-40 bg-[#FBFBF9] overflow-y-auto flex flex-col h-full text-[#1F251A] isolate">
