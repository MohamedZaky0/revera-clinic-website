...
export default function DoctorSessionDrawer({
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 md:p-6 bg-black/40">
      ...
      <div className="relative w-full max-w-3xl max-h-[90vh] bg-white shadow-2xl rounded-3xl z-10 flex flex-col overflow-hidden border border-[#414E36]/15">
