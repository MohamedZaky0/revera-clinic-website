...
export default function DoctorSidebar({
  ...
  return (
    <>
      ...
      <aside
        dir={lang === "ar" ? "rtl" : "ltr"}
        className={`fixed inset-y-0 start-0 z-50 flex w-[280px] max-w-[85vw] md:w-[220px] h-screen max-h-screen flex-col justify-between bg-[#414E36] px-3.5 py-5 text-[#FBFBF9] shadow-[0_0_70px_rgba(0,0,0,0.08)] transition-transform duration-300 md:static md:z-auto md:h-screen md:sticky md:top-0 md:translate-x-0 shrink-0 overflow-y-auto ${
          sidebarOpen
            ? "translate-x-0"
            : lang === "ar"
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between pb-2 border-b border-white/10">
            ...
            <button
              type="button"
              onClick={() => setSidebarOpen && setSidebarOpen(false)}
              className="md:hidden h-8 w-8 rounded-xl bg-white/10 hover:bg-white/20 text-white flex items-center justify-center transition cursor-pointer"
              title="Close Menu"
            >
              <X size={18} />
            </button>
