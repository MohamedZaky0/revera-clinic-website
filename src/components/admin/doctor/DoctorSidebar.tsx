...
export default function DoctorSidebar({
  ...
  return (
    <>
      ...
      <aside
        dir={lang === "ar" ? "rtl" : "ltr"}
        className={`fixed inset-y-0 start-0 z-50 flex w-[260px] md:w-[220px] h-screen flex-col justify-between bg-[#414E36] px-3.5 py-5 text-[#FBFBF9] shadow-[0_0_70px_rgba(0,0,0,0.08)] transition-transform duration-300 md:sticky md:top-0 md:translate-x-0 shrink-0 overflow-y-auto ${
