...
const DEFAULT_TERMS: TermItem[] = [
  ...
  },
  {
    ...
    content_en: "You can cancel or reschedule your appointment through our website or by contacting us. Please review our ",
    content_ar: "يمكنك إلغاء أو إعادة جدولة موعدك من خلال موقعنا أو بالاتصال بنا. يرجى مراجعة ",
  ...
  },
  {
    ...
    content_en: "Certain services may require advance payment. Refund eligibility depends on our ",
    content_ar: "قد تتطلب بعض الخدمات الدفع المسبق. تعتمد أهليّة الاسترداد على ",
  ...
  useEffect(() => {
    async function loadTerms() {
      try {
        ...
        console.error('Failed to load terms from API:', e);
      }
    }
    loadTerms();
  }, []);
