...
| — | Finance screens do not count `is_opening` invoices as live revenue | dev, browser | — | Not run — **not audited** |
...
- [ ] Open Finance → revenue/tax screens for the periods the history falls in and confirm nothing jumped.
